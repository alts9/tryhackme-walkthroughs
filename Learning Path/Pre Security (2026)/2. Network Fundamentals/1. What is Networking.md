##### Link: [What is Networking?](https://tryhackme.com/room/whatisnetworking)
---
...
5. Deploy the interactive lab using the "View Site" button and spoof your MAC address to access the site.  What is the flag?
	- Copy Alice’s MAC address and click `Request Site`
		- ![](../../../Attachment/2026-04-06_19-52-15_edit%201.png)
	- ------------
...
3. What flag do you get when you ping 8.8.8.8?
	- Enter target IP then send the request
		- ![](../../../Attachment/Pasted%20image%2020260406195656.png)
	- ------------
	- Flag: `THM{I_PINGED_THE_SERVER}`
---
##### Task 5: Continue Your Learning: Intro to LAN
1. Join the "Intro to LAN" room.
	- `No answer needed`
---
